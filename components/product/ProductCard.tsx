...
export default function ProductCard({ product, onQuickView, priority }: ProductCardProps) {
  ...
  return (
    <MotionLink
      ...
      className="group relative flex h-full cursor-pointer flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] transition-all duration-300 hover:border-blue-400/40 hover:shadow-[0_0_40px_-8px_rgba(59,130,246,0.6)]"
    >
      {/* Media */}
